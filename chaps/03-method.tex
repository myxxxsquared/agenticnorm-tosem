...
\begin{itemize}
    \item \textbf{Constraint Learning Agent}: derives constraints from normal logs.
    \item \textbf{Attack Generation Agent}: synthesizes attack logs that break or bypass the learned constraints.
    \item \textbf{Prompt Refinement Agent}: updates LLM prompts using feedback from undetected attacks.
\end{itemize}
