...
\begin{enumerate}
    ...
    How effective is LightNorm in detecting web tamper attacks compared to state-of-the-art baselines and WebNorm? 
    We evaluate its precision, recall, and F1-score on standard benchmarks.

    \item \textbf{RQ2: Ablation Study.} 
    How do the core components of LightNorm contribute to its performance? 
    ...
    How does LightNorm perform when deployed with different scales of lightweight, locally deployable LLMs? 
...
\begin{table}
	\centering
	\caption{Overall evaluation of LightNorm}
	...
	\begin{tabular}{l|c|c|c|c}
		...
		\textbf{LightNorm (Ours)}         & \textbf{1.000}                             & \textbf{0.760}                         & \textbf{1.000}     & \textbf{X}  \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabular}{l|c|c}
		...
		\midrule
		\textbf{Original (LightNorm)} & \textbf{X}        & \textbf{X}     \\
		\midrule
