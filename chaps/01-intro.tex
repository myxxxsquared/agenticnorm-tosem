...
LightNorm integrates these components into a \textbf{multi-agent workflow}, where agents for invariant generation, attack generation, and prompt refinement cooperate iteratively. The result is a system that adapts and self-improves without extensive human involvement.

\paragraph{Contributions.} This paper makes the following contributions:
\begin{itemize}
    \item We identify the key limitations of WebNorm—heavyweight LLM dependency, source code reliance, and prompt fragility—and propose LightNorm as a lightweight alternative.
