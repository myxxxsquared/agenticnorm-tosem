...
In principle, backend applications implement authorization checks and other safeguards to prevent such manipulations. However, because attack behaviors are often difficult to exhaustively cover through conventional frontend testing, certain attack actions may escape detection by the backend, leaving exploitable vulnerabilities.  
