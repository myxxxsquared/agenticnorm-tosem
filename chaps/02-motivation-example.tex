...
(2) \textbf{Rule-learning-based detectors}, which derive semantic constraints from logs and flag violations.
...
Manual prompt adjustment is both time-consuming and highly project-specific.
